...
CREATE TABLE USERS_raj1174 (
  username VARCHAR(20) PRIMARY KEY,
  password VARBINARY(144) NOT NULL,
  balance INT NOT NULL
);

CREATE TABLE RESERVATIONS_raj1174 (
  rid INT PRIMARY KEY,
  paid INT NOT NULL,
  fid INT REFERENCES FLIGHTS(fid) NOT NULL,
  fid2 INT REFERENCES FLIGHTS(fid),
  username VARCHAR(20) REFERENCES USERS_raj1174(username)
);